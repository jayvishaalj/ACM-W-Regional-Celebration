(function ($) {
    ...
    // ****************************
    if ($.fn.countdown) {
        var countDownDate = new Date("Oct 10, 2020 14:00:00").getTime();
        ...
        var x = setInterval(function () {
            ...
            document.getElementById("month").innerHTML = "0 <span>Months</span>";
            ...
            if (distance < 0) {
                clearInterval(x);
                document.getElementById("parentClock").innerHTML = `<div class="about-content-text mb-80"><h3 class="wow fadeInUp" data-wow-delay="300ms">Event Completed!</h3></div>`;
            }
        }, 1000);
    }
